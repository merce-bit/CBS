...
DECLARE
    ...
    ScriptName VARCHAR(100) := 'Creation HIV_0000000015 table';
    ...
    Description VARCHAR(500) := 'Initial creation of the HIV_0000000015 table';
...
BEGIN
    ...
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM metadata."ControlTable" WHERE "ScriptName" = ScriptName AND "Version"= Version ) THEN
            ...
            CREATE TABLE IF NOT EXISTS raw."WHO_HIV_0000000015"
            (
                id numeric NOT NULL,
