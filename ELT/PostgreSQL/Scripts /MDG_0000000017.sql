...
DECLARE
    ...
    ScriptName VARCHAR(100) := 'Creation MDG_0000000017 table';
    ...
    Description VARCHAR(500) := 'Initial creation of the MDG_0000000017 table';
...
BEGIN
    ...
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM metadata."ControlTable" WHERE "ScriptName" = ScriptName AND "Version"= Version ) THEN
            ...
            CREATE TABLE IF NOT EXISTS raw."WHO_MDG_0000000017"
            (
                id numeric NOT NULL,
