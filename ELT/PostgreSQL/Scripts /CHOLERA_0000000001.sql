...
DECLARE
    ...
    ScriptName VARCHAR(100) := 'Creation CHOLERA_0000000001 table';
    ...
    Description VARCHAR(500) := 'Initial creation of the CHOLERA_0000000001 table';
...
BEGIN
    ...
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM metadata."ControlTable" WHERE "ScriptName" = ScriptName AND "Version"= Version ) THEN
            ...
            CREATE TABLE IF NOT EXISTS raw."WHO_CHOLERA_0000000001"
            (
                id numeric NOT NULL,
